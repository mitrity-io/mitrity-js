...
`@mitrity/sdk` sits between an AI agent's framework and the MITRITY edge that
...
Please include the package version (`npm ls @mitrity/sdk`), the Agent SDK
version, Node.js version, a minimal reproduction, and what the edge answered
(or did not).
